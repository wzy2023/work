...
type SchemaType = z.ZodType<Prisma.RssFeedUncheckedCreateWithoutLogsInput>;
export const RssFeedUncheckedCreateWithoutLogsInputObjectSchema: SchemaType = z.object({
    ...
    z.null()]).optional().nullable(), name: z.string(), url: z.string(), tags: z.union([z.lazy(() => JsonNullValueInputSchema),
        ...
        z.null()]).optional().nullable(), frequency: z.string(), enabled: z.boolean().optional().optional(), items: z.lazy(() => RssItemUncheckedCreateNestedManyWithoutFeedInputObjectSchema).optional().optional()
