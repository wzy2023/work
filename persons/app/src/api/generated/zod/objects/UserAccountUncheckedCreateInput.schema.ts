...
type SchemaType = z.ZodType<Prisma.UserAccountUncheckedCreateInput>;
export const UserAccountUncheckedCreateInputObjectSchema: SchemaType = z.object({
    ...
    z.null()]).optional().nullable(), userId: z.string(), type: z.string(), provider: z.string(), providerAccountId: z.string(), refresh_token: z.union([z.string(),
