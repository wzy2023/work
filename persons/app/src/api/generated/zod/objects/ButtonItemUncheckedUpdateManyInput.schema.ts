...
type SchemaType = z.ZodType<Prisma.ButtonItemUncheckedUpdateManyInput>;
export const ButtonItemUncheckedUpdateManyInputObjectSchema: SchemaType = z.object({
    id: z.union([z.string(),
    ...
    z.null()]).optional().nullable(), groupId: z.union([z.string(),
