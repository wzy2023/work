...
// 这个是为了后期的修改Prompt内容考虑，因为要针对无chatId的list进行修改，且考虑到不能出现标题和内容的冲突，所以就需要一个临时item来记录一下
...
<template>
  <NModal title='提示词管理' v-model:show="show" style="width: 90%; max-width: 900px;" preset="card">
    <div class="space-y-4">
      <NTabs type="segment">
