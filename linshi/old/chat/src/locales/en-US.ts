export default {
  common: {
    ...
    failed: 'Failed',
    verify: 'Verify',
    unauthorizedTitle: 'Not logged in',
    unauthorizedTips: 'Please log in using WeChat QR code scanning first~',
  },
  chat: {
    stopResponding: 'Stop Responding',
    chatBootStrap: 'What do you want to ask me~',
