...
import { z } from 'zod';
import { UserItemCreateNestedOneWithoutAccountsInputObjectSchema } from './UserItemCreateNestedOneWithoutAccountsInput.schema';

import type { Prisma } from '@prisma/client';

type SchemaType = z.ZodType<Prisma.UserAccountCreateInput>;
export const UserAccountCreateInputObjectSchema: SchemaType = z.object({
    ...
    z.null()]).optional().nullable(), user: z.lazy(() => UserItemCreateNestedOneWithoutAccountsInputObjectSchema)
