...
type SchemaType = z.ZodType<Prisma.RssFeedCreateManyInput>;
export const RssFeedCreateManyInputObjectSchema: SchemaType = z.object({
    ...
    z.null()]).optional().nullable(), name: z.string(), url: z.string(), tags: z.union([z.lazy(() => JsonNullValueInputSchema),
        ...
        z.null()]).optional().nullable(), frequency: z.string(), enabled: z.boolean().optional().optional()
