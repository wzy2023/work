...
import { z } from 'zod';
import { UserAccountProviderProviderAccountIdCompoundUniqueInputObjectSchema } from './UserAccountProviderProviderAccountIdCompoundUniqueInput.schema';
...
type SchemaType = z.ZodType<Prisma.UserAccountWhereUniqueInput>;
export const UserAccountWhereUniqueInputObjectSchema: SchemaType = z.object({
    id: z.string().optional().optional(), provider_providerAccountId: z.lazy(() => UserAccountProviderProviderAccountIdCompoundUniqueInputObjectSchema).optional().optional(), AND: z.union([z.lazy(() => UserAccountWhereInputObjectSchema),
    z.lazy(() => UserAccountWhereInputObjectSchema).array()]).optional(), OR: z.lazy(() => UserAccountWhereInputObjectSchema).array().optional().optional(), NOT: z.union([z.lazy(() => UserAccountWhereInputObjectSchema),
    z.lazy(() => UserAccountWhereInputObjectSchema).array()]).optional(), createdAt: z.union([z.lazy(() => DateTimeFilterObjectSchema),
    ...
    z.string(),
    z.null()]).optional().nullable(), user: z.union([z.lazy(() => UserItemScalarRelationFilterObjectSchema),
