...
type SchemaType = z.ZodType<Prisma.AiRoleScalarWhereWithAggregatesInput>;
export const AiRoleScalarWhereWithAggregatesInputObjectSchema: SchemaType = z.object({
    AND: z.union([z.lazy(() => AiRoleScalarWhereWithAggregatesInputObjectSchema),
    z.lazy(() => AiRoleScalarWhereWithAggregatesInputObjectSchema).array()]).optional(), OR: z.lazy(() => AiRoleScalarWhereWithAggregatesInputObjectSchema).array().optional().optional(), NOT: z.union([z.lazy(() => AiRoleScalarWhereWithAggregatesInputObjectSchema),
    z.lazy(() => AiRoleScalarWhereWithAggregatesInputObjectSchema).array()]).optional(), id: z.union([z.lazy(() => StringWithAggregatesFilterObjectSchema),
