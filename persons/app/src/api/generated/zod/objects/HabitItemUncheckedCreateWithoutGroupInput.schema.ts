...
import { HabitRecordUncheckedCreateNestedManyWithoutHabitInputObjectSchema } from './HabitRecordUncheckedCreateNestedManyWithoutHabitInput.schema';
...
type SchemaType = z.ZodType<Prisma.HabitItemUncheckedCreateWithoutGroupInput>;
export const HabitItemUncheckedCreateWithoutGroupInputObjectSchema: SchemaType = z.object({
    ...
    z.null()]).optional().nullable(), count: z.union([z.lazy(() => NullableJsonNullValueInputSchema),
        jsonSchema]).optional(), frequency: z.union([z.lazy(() => NullableJsonNullValueInputSchema),
            jsonSchema]).optional(), records: z.lazy(() => HabitRecordUncheckedCreateNestedManyWithoutHabitInputObjectSchema).optional().optional()
