...
type SchemaType = z.ZodType<Prisma.UserItemCreateManyInput>;
export const UserItemCreateManyInputObjectSchema: SchemaType = z.object({
    ...
    z.null()]).optional().nullable(), role: z.string().optional().optional()
