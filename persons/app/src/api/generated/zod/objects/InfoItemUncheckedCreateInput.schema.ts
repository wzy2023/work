...
type SchemaType = z.ZodType<Prisma.InfoItemUncheckedCreateInput>;
export const InfoItemUncheckedCreateInputObjectSchema: SchemaType = z.object({
    ...
    z.null()]).optional().nullable(), key: z.string(), enabled: z.boolean().optional().optional()
