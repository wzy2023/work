...
type SchemaType = z.ZodType<Prisma.HabitRecordCreateManyInput>;
export const HabitRecordCreateManyInputObjectSchema: SchemaType = z.object({
    ...
    z.null()]).optional().nullable(), execList: z.union([z.lazy(() => NullableJsonNullValueInputSchema),
        jsonSchema]).optional(), habitId: z.string()
